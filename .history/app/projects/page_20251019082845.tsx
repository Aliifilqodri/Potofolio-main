...
import { ExternalLink, Award } from "lucide-react"; // Menambahkan ikon Award
...
// --- DATA SERTIFIKAT (Duplikasi sudah dihapus) ---
const certificates = [
  {
  ...
  // Tambahkan sertifikat lain di sini jika ada
];
...
// --- KOMPONEN BARU: KARTU SERTIFIKAT ---
const CertificateCard = ({ cert }) => (
  <motion.a
    ...
    variants={fadeInUp}
    className="group block relative aspect-[4/3] w-full overflow-hidden rounded-xl shadow-lg border border-border/20"
  ...
  >
    ...
    <div className="relative h-full flex flex-col justify-end p-6 text-white">
      ...
      <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform group-hover:translate-y-0 translate-y-4">
        <span className="flex items-center gap-2 px-4 py-2 text-sm font-semibold bg-primary text-primary-foreground rounded-full shadow-lg">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative isolate overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle at 10% 20%, rgba(var(--primary-rgb), 0.1) 0%, transparent 25%), radial-gradient(circle at 80% 90%, rgba(var(--primary-rgb), 0.1) 0%, transparent 25%)",
        }}
        ...
        <section id="projects" className="py-24 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              initial="initial" whileInView="animate" variants={staggerContainer} viewport={{ once: true }}
            >
        ...
        <section id="certificates" className="py-24 px-4 bg-muted/30">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-foreground/60 max-w-2xl mx-auto mt-4">
                A collection of my certifications that validate my skills and expertise.
              </p>
            </motion.div>
