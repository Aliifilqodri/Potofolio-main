...
// --- KOMPONEN KARTU PROYEK (untuk menghindari duplikasi kode) ---
        ...
        <section id="certificates" className="py-24 px-4 bg-muted/30">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative">
              <motion.div
                className="flex gap-8 cursor-grab p-4" // padding added for better shadow visibility
                drag="x"
        ...
        <section id="testimonials" className="py-24 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              {/* h1 "What Others Say" TELAH DIHAPUS DARI SINI */}
            </motion.div>
            <motion.div
              className="grid md:grid-cols-2 lg:grid-cols-2 gap-8" // Dibuat 2 kolom agar lebih terbaca
              initial="initial"
              whileInView="animate"
              variants={staggerContainer}
              viewport={{ once: true }}
