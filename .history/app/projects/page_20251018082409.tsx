...
const fadeInUp = {
  ...
  animate: {
    opacity: 1,
    y: 0,
    transition: { duration: 0.6, ease: [0.6, -0.05, 0.01, 0.99] }, // Easing yang lebih profesional
  },
};

const staggerContainer = {
  initial: {}, // initial state tidak perlu didefinisikan di sini
  animate: {
    transition: {
      staggerChildren: 0.1,
    },
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="flex-grow">
                    <QuoteIcon className="text-primary/50 w-8 h-8 mb-4" />
