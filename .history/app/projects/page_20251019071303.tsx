...
const projects = [
  ...
  description: "An integrated system to streamline operational issue reporting. Users can instantly create tickets via a Telegram bot, which are then logged and displayed on a real-time dashboard for efficient monitoring and resolution.",
  tags: ["React", "Node.js", "Telegram Bot", "API", "MongoDB"],
  image: "port/db.png",
  link: "#", // Ganti dengan link proyek Anda
},
  {
