...
import Link from "next/https://formspree.io/f/meordonr";
...
import { Mail, MapPin, Phone, Github, Linkedin, Instagram, SendHorizontal, Loader2, CheckCircle2, XCircle } from "lucide-react";
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/YOUR_UNIQUE_ID", { // <-- GANTI DENGAN URL FORM ANDA
        method: "POST",
