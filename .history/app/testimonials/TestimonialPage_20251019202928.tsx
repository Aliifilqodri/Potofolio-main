// app/testimonials/TestimonialPage.tsx
...
import {
  ...
  Quote,
  Upload,
  CheckCircle2, // Ini tidak dipakai lagi, bisa dihapus kalau mau
  XCircle,      // Ini tidak dipakai lagi, bisa dihapus kalau mau
  Loader2,
  X, // <-- Import icon 'X' untuk tombol tutup modal
} from "lucide-react";
...
// ✅ PERUBAHAN DI SINI: Menerima prop onImageClick
const TestimonialCard = ({ testimonial, onImageClick }: { testimonial: Testimonial; onImageClick: (src: string, alt: string) => void }) => {
  return (
    <motion.div
      layout
    ...
    >
      ...
      <div className="relative z-10 space-y-4">
        ...
        <div className="flex items-center gap-3 pt-4 border-t border-border">
          {testimonial.photo && (
            // ✅ PERUBAHAN DI SINI: Tambahkan onClick untuk memicu modal
            <div
...
export default function Testimonials({
  ...
  const openImageModal = (src: string, alt: string) => {
    ...
    setIsModalOpen(true);
    // Opsional: nonaktifkan scroll di body saat modal terbuka
  ...
  const closeImageModal = () => {
    ...
    // Opsional: aktifkan kembali scroll di body
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Grid Testimoni (✅ PERUBAHAN DI SINI: Meneruskan prop onImageClick ke TestimonialCard) */}
          ...
          <AnimatePresence>
            {testimonials.map((testimonial) => (
              <TestimonialCard 
                ...
                onImageClick={openImageModal} // <-- Teruskan fungsi ini
              />
            ))}
          </AnimatePresence>
        </div>
      ...
      {/* Formulir Testimoni (tidak ada perubahan) */}
      ...
      <AnimatePresence>
        {isModalOpen && selectedImage && (
          <motion.div
            ...
            onClick={closeImageModal} // Tutup modal saat overlay diklik
          >
            <motion.div
              ...
              onClick={(e) => e.stopPropagation()} // Hindari penutupan saat mengklik gambar itu sendiri
            >
              <button
              ...
              <div className="relative w-full h-full max-w-[80vw] max-h-[80vh]">
                <Image
                  ...
                  fill
                  style={{ objectFit: 'contain' }} // Atur objectFit agar gambar tidak terpotong
