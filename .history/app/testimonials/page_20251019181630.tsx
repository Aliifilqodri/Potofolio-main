...
export default function Testimonials() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const collectioon = db.collection("pizzaMenu");
    const doc = { name: formData.name, description: formData.description, stars:rating, photo: selectedFile ? selectedFile.name : null };
    const result = await dollection.insertOne(doc);
