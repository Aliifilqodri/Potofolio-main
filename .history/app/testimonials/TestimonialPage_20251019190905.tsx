...
export default function Testimonials({ handleSubmitDB, testimonials: initialTestimonials }: { handleSubmitDB: (data: { name: string; description: string; stars: string; photo?: string }) => Promise<any>; testimonials: Testimonial[] }) {
