...
export async function GET() {
  try {
    ...
    const db = client.db("portopoliolipz") // <- SUDAH DIGANTI
    ...
    console.error("API GET Error:", error); // Tambahan untuk debugging
...
export async function POST(request) {
  try {
    ...
    console.error("API POST Error:", error); // Tambahan untuk debugging
