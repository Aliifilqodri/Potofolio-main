...
const creatorPlatforms = [
  {
    platform: "TikTok",
    description:
      "Konten video pendek yang kreatif dan engaging seputar cerita dan teknologi.",
    link: "https://www.tiktok.com/@aalipli?lang=en", // Ganti dengan link Anda
    logo: "/upload/tiktok.png",
    profileImage: "upload/aliif-profile.png", // Foto profil Anda
  },
  {
    platform: "YouTube",
    description:
      "Video esai dan pembahasan mendalam tentang dunia kreatif dan pengembangan diri.",
