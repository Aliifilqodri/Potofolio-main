...
// --- MASTER DATA STRUCTURE FOR ALL EXPERIENCES ---
const experiences = [
  {
    icon: <GraduationCap />,
  ...
  },
  {
    ...
    duration: "2024",
    description:
      "Collaborated within 'Team Asikin' to design an intuitive user interface and engaging user experience for a mobile application. My responsibilities focused on prototyping, usability, and visual storytelling using Figma.",
    tags: ["Figma", "UI Design", "Prototyping", "User Research"],
    image: "/cert/aiscomp-winner.png", // Image path for the card view
  },
  {
    icon: <Video />,
...
// --- COMPONENT FOR WORK EXPERIENCE CARDS ---
const ExperienceCard = ({ experience }) => {
  return (
    <motion.div
      className="bg-muted/50 border border-border p-6 rounded-lg shadow-sm backdrop-blur-sm hover:border-primary/50 transition-colors duration-300"
      initial="initial"
      whileInView="animate"
      variants={fadeInUp}
      ...
      <div className="flex flex-col sm:flex-row gap-6 items-center">
        ...
        {experience.image && (
          <div className="w-full sm:w-1/3 flex-shrink-0">
            ...
            <img
              ...
              alt={`${experience.role} certificate or project`}
        ...
        <div className="flex-1">
          <div className="flex items-start gap-4 mb-3">
            <span className="text-primary mt-1">{experience.icon}</span>
            <div>
...
export default function Experience() {
  ...
  // Filter for work experiences to be displayed in cards
  const workExperiences = experiences.filter(
    (exp) => exp.icon.type === Briefcase
  );
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Work Experience Card Section */}
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-black text-center mb-16">
