...
import { Briefcase, GraduationCap, Wrench, Video, Code, Globe, PenTool } from "lucide-react";
...
const experiences = [
...

  {
    ...
    duration: "2023",
    description:
      "Designed intuitive user interfaces and engaging user experiences for mobile applications such as 'Asikin'. Focused on prototyping, usability, and visual storytelling using Figma.",
