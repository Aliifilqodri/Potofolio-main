...
const experiences = [
  ...
  },
  {
    ...
    duration: "Ongoing",
    description:
      "Mengeksplorasi integrasi antara perangkat keras dan perangkat lunak untuk memecahkan masalah dunia nyata, dari sistem otomatisasi hingga robotika.",
    tags: ["LabVIEW", "Hardware", "Software Integration"],
  },
