...
// --- GANTI IKON PUZZLE DENGAN FEATHER ---
import { Code, Brush, Feather, Download } from "lucide-react"; 
import React from "react";

// --- DATA LOGO (TETAP SAMA) ---
const techLogos = [
  { src: "/tech-logos/react.png", alt: "React", size: 40, duration: 15 },
  { src: "/tech-logos/nextjs.png", alt: "Next.js", size: 35, duration: 18 },
  { src: "/tech-logos/tailwind.png", alt: "Tailwind CSS", size: 45, duration: 20 },
  { src: "/tech-logos/typescript.png", alt: "TypeScript", size: 38, duration: 16 },
  { src: "/tech-logos/figma.png", alt: "Figma", size: 42, duration: 17 },
  { src: "/tech-logos/mongodb.png", alt: "MongoDB", size: 30, duration: 19, reverse: true },
...
      {/* Latar Belakang Aurora Dinamis (Tetap Sama) */}
      <div
...
            initial="initial" whileInView="animate" variants={staggerContainer} viewport={{ once: true, amount: 0.4 }}
          >
            {/* GAMBAR DENGAN EFEK PARALLAX 3D (Tetap Sama) */}
            <motion.div
              ref={ref}
...
              variants={fadeInUp}
            >
              {/* ... (Kode gambar & orbit logo tetap sama, hanya ganti alt text) ... */}
              <div style={{ transform: "translateZ(8px)", transformStyle: "preserve-3d" }} className="relative p-4 border-2 border-primary/20 rounded-xl">
...
                      style={{ width: logo.size, height: logo.size, x: xPos - logo.size / 2, y: yPos - logo.size / 2 }}
                      animate={{ rotate: logo.reverse ? -360 : 360 }}
                      transition={{ repeat: Infinity, ease: "linear", duration: logo.duration }}
                    >
...
              {/* === MY PHILOSOPHY SECTION (DIROMBAK TOTAL) === */}
...
                  <div className="p-3 bg-primary/10 text-primary rounded-full border border-primary/20">
                      {/* Ikon baru yang melambangkan kreativitas dan tulisan */}
                    <Feather className="w-6 h-6" />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg">Engaging Storytelling</h4>
                    <p className="text-foreground/60">
                      My core passion is crafting narratives that connect. Whether through a TikTok video or a piece of writing, I create content that captures attention and leaves a lasting impact.
                    </p>
                  </div>
                </div>
...
                    <p className="text-foreground/60">
                      Every interaction is a chapter in the user's journey. I focus on creating intuitive, beautiful, and accessible designs that guide the user and make their experience memorable.
                    </p>
                  </div>
                </div>
...
                  </div>
                  <div>
                    <h4 className="font-bold text-lg">Robust Backend Development</h4>
                    <p className="text-foreground/60">
                      I build the digital stage for every story. From efficient back-end systems to responsive interfaces, I ensure the underlying technology is reliable, scalable, and seamless.
                    </p>
                  </div>
                </div>
              </motion.div>
