          ...
          >
            ...
            >
              ...
              >
                ...
                'Boring Content' and 'Clunky User Experience'.
              </motion.p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/60">
                      I bridge the gap between wild ideas and stellar reality.
                      Armed with the dynamic power of TikTok storytelling and
                      the secret arts of back-end development, I turn concepts
                      into tangible, awe-inspiring digital experiences.
                      I bridge the gap between wild ideas and stellar reality. Armed with the dynamic power of TikTok storytelling and the secret arts of back-end development, I turn concepts into tangible, awe-inspiring digital experiences.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/60">
                      write code that’s not just clean, but lightning-fast and
